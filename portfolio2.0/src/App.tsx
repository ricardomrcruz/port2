...
function App() {
  ...
  return (
    <div className="w-full flex flex-col text-white">
      ...
      <section className="w-[40%] m-auto text-justify">
        <div className="flex w-full justify-between mt-6">
          <div className="w-[70%] ">
            <h1 className="text-6xl py-3">Hi, I'm Ricardo ✌️</h1>
        ...
        <div className="my-10">
          ...
          <p className="text-gray-400 text-base">
            ...
            , he has built custom CRM solutions in partnerships in-company,
            deployed SAAS apps and solutions, and contributed actively to the{" "}
            <a href="" className="underline text-purple-900">
