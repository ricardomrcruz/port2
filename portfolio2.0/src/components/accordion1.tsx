    ...
    <div id="accordion-open" data-accordion="open">
      ...
      <div id="accordion-open-heading-4 ">
        <button
          type="button"
          className="group flex items-center justify-between w-full  font-medium rtl:text-right  gap-3"
          aria-expanded={openAccordion["accordion-open-body-4"]}
        ...
        >
          <span className="flex items-center">
            ...
            <div className="text-left px-4">
              <p className="text-base sm:text-lg">Green Distribution France</p>
              <p className="text-[11px] sm:text-xs text-gray-200">
                Web Developer
              </p>
            </div>
      ...
      >
        <p className=" text-gray-300 ">
          <ul className="space-y-4">
            <li>
              Led the development and maintenance of a suite of B2B e-commerce
              platforms for ARAN HOLDING subsidiary, managing multiple branded
              sites including green-distrib.fr, cbdburaliste.fr,
              bigcbdproduct.com, cbdeau.be, and californiakush.fr.
            </li>

            <li>
              Delivered comprehensive full-stack CMS solutions using PHP/MySQL
              and HTML/CSS/JavaScript, while driving UX/UI design improvements.
              Engineered and implemented an automated billing system,
              streamlining B2B client network management and improving
      ...
      <div id="accordion-open-heading-2">
        ...
        >
          <span className="flex items-center">
            ...
            <div className="text-left px-4">
              <p className="text-base sm:text-lg">MyMetal® Dangolsheim</p>
              <p className="text-[11px] sm:text-xs text-gray-200">
                Web Developer
              </p>
            </div>
        ...
        <p className=" text-gray-300">
          <ul className="space-y-4">
            ...
            <li>
              ...
              React/JavaScript HTML/TailwindCSS frontend development, and Google
